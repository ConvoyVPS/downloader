    ...
    [
        {
            "name": "Ubuntu",
            "templates": [
                { "name": "Ubuntu 18.04", "vmid": 2000, "link": "https://images.cdn.convoypanel.com/ubuntu/ubuntu-18-04-amd64.vma.zst" },
                { "name": "Ubuntu 20.04", "vmid": 2001, "link": "https://images.cdn.convoypanel.com/ubuntu/ubuntu-20-04-amd64.vma.zst" },
                { "name": "Ubuntu 22.04", "vmid": 2002, "link": "https://images.cdn.convoypanel.com/ubuntu/ubuntu-22-04-amd64.vma.zst" }
            ]
        },
        {
            "name": "Windows Server",
            "templates": [
                { "name": "Windows Server 2019", "vmid": 9000, "link": "https://images.cdn.convoypanel.com/windows/windows-2019-datacenter-amd64.vma.zst" },
                { "name": "Windows Server 2022", "vmid": 9001, "link": "https://images.cdn.convoypanel.com/windows/windows-2022-datacenter-amd64.vma.zst" }
            ]
        },
        {
            "name": "CentOS",
        ...
        { "name": "Debian", "templates": [{ "name": "Debian 11", "vmid": 1001, "link": "https://images.cdn.convoypanel.com/debian/debian-11-amd64.vma.zst" }] },
